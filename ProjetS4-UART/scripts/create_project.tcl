...
#
# create_project.tcl: Tcl script for re-creating project 'ProjetS4-UART'
#
# Generated by Vivado on Thu Jun 04 13:24:41 -0400 2026
...
set _xil_proj_name_ "ProjetS4-UART"
...
\
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
...
if { [get_property IS_LOCKED [ get_files -norecurse [list uart.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../ProjetS4-UART.gen/sources_1/bd/uart/hdl/uart_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list uart.bd]] -top]
